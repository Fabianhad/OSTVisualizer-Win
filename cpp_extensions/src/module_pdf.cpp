...
NB_MODULE(ost_pdf, m)
{
        ...
        nb::class_<PDFTextChar>(m, "PDFTextChar",
                                "One embedded PDF text character with a raw PDF user-space box")
            .def_ro("text", &PDFTextChar::text,
                    "Character text as UTF-8")
            .def_ro("left", &PDFTextChar::left,
                    "Left coordinate in PDF user-space points")
            .def_ro("right", &PDFTextChar::right,
                    "Right coordinate in PDF user-space points")
            .def_ro("bottom", &PDFTextChar::bottom,
                    "Bottom coordinate in PDF user-space points")
            .def_ro("top", &PDFTextChar::top,
                    "Top coordinate in PDF user-space points")
            .def_ro("page_index", &PDFTextChar::page_index,
                    "Zero-based page index");
        nb::class_<PDFTextRun>(m, "PDFTextRun",
                               "A contiguous PDF text run with raw PDF user-space boxes")
            .def_ro("text", &PDFTextRun::text,
                    "Text content as UTF-8")
            .def_ro("left", &PDFTextRun::left,
                    "Left coordinate in PDF user-space points")
            .def_ro("right", &PDFTextRun::right,
                    "Right coordinate in PDF user-space points")
            .def_ro("bottom", &PDFTextRun::bottom,
                    "Bottom coordinate in PDF user-space points")
            .def_ro("top", &PDFTextRun::top,
                    "Top coordinate in PDF user-space points")
            .def_ro("page_index", &PDFTextRun::page_index,
                    "Zero-based page index")
...
of the loaded page. Curves, text outlines, and image content are ignored.
            ...
            .def("extract_text_runs", &PDFRenderer::extract_text_runs,
                 ...
                 nb::call_guard<nb::gil_scoped_release>(),
                 R"doc(
Extract embedded PDF text as word-like runs with character boxes.
Coordinates are PDF user-space points with the origin at the bottom-left
