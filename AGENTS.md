...
Expected public MCP counts should remain 25 tools, 1 resource, 4 resource templates, and 2 prompts unless a change intentionally updates the public surface.
