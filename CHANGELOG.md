...
- Updated exported HTML 3D views to preserve layer metadata, show a website-style layer visibility panel, and let hidden-layer geometry be revealed in the standalone viewer.
