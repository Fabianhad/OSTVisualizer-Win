...
- Replaced high-resolution PDF tile refresh with visible-frame PDFium offset rendering, renderer-rounded placement, and buffered cache replacement to avoid blurry, drifting, distorted, or blank zoomed PDF overlay views.
