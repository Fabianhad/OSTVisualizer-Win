...
- Added shared toolbar/menu/context-menu/Annotation Window placement tools for text, line, arrow, rectangle, oval, polygon, and cloud annotations, including click-point and click-drag Polygon/Cloud placement.
