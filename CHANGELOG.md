...
- Fixed PDF takeoff pattern generation hanging on invalid converted spacing and emitting zero-length diagonal artifacts where scan lines pass through polygon vertices.
