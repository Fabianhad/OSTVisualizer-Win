...
[![Version](https://img.shields.io/badge/version-1.2.6-blue)](https://fabianhad.com/ost3d/download)
...
- **`ost3dvisualizer-1.2.6-64.msi`** -- Windows 64-bit installer (Windows 10+)
