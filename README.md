...
[![Version](https://img.shields.io/badge/version-1.2.6.1-blue)](https://fabianhad.com/ost3d/download)
...
- **Takeoff Toolbar Preferences** -- Use **Tools > Options > Takeoff Toolbar** to hide or show individual navigation, cursor, annotation, zoom, and Page Settings controls in Main's horizontal Takeoff strip. Apply or OK saves your choices across restarts; Cancel discards unapplied edits. **Restore Default Toolbar** restores all controls after Apply/OK. Existing menu commands and shortcuts remain available, including Tools > Options when the strip is completely hidden. Other toolbars and detached windows keep their existing layout.
...
- **`ost3dvisualizer-1.2.6.1-64.msi`** -- Windows 64-bit installer (Windows 10+)
