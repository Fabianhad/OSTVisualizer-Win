    ...
    def _get_menu_definition(self) -> Dict[str, list]:
        ...
        return {
            ...
            "View": [
                ...
                ("sep",),
                ("shared", "next_page"),
                ("shared", "previous_page"),
                ("sep",),
                ("shared", "layers_sidebar"),
                ("shared", "conditions_sidebar"),
                ("shared", "status_bar"),
            ...
            "Image": [
                ...
                (
                    ...
                    [
                        ...
                        ("sep",),
                        ("cmd", "Rotate Image Left", "rotate_image_left"),
                        ("cmd", "Rotate Image Right", "rotate_image_right"),
                        ("cmd", "Flip Image Horizontal", "flip_image_horizontal"),
                        ("cmd", "Flip Image Vertical", "flip_image_vertical"),
                    ],
                ),
                ("sep",),
                ("cmd", "Select Overlay Image", "select_overlay_image"),
                ("cmd", "Remove Overlay Image", "remove_overlay_image"),
                ("sep",),
                (
                    "check",
                    "Show Overlay Image",
            ...
            "Project": [
                ("cmd", "Show Cover Sheet", "show_cover_sheet"),
