...
class QtSceneNotifier(QObject):
    ...
    def __init__(self, parent: Optional[QObject] = None) -> None:
        ...
        self._on_scene_ready: Optional[Callable[[List, Any, int], None]] = None
        self._on_full_refresh: Optional[Callable[[str], None]] = None

    def set_handlers(
        self,
        on_scene_ready: Callable[[List, Any, int], None],
    ...
    def notify_scene_ready(self, geometries: List, bounds: Any, gen_id: int) -> None:
