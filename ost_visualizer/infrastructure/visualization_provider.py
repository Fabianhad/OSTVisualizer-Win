    ...
    def render(
        ...
        try:
            ...
            visualize_with_threejs(
                ...
                page_uid=page_uid,
                page_width_2d=page_width_2d,
                page_height_2d=page_height_2d,
                page_scale_ratio=page_scale_ratio,
                page_rotation=page_rotation,
                page_flip_x=page_flip_x,
                page_flip_y=page_flip_y,
                layers=layers,
                areas=areas,
...
class _HtmlExportStrategyAdapter(IExportStrategy):
    ...
    def execute_export(
        ...
        return self._html_renderer.render(
            ...
            page_uid=kwargs.get("page_uid", ""),
            page_width_2d=kwargs.get("page_width_2d", 0.0),
            page_height_2d=kwargs.get("page_height_2d", 0.0),
            page_scale_ratio=kwargs.get("page_scale_ratio", 1.0),
            page_rotation=kwargs.get("page_rotation", 0),
            page_flip_x=kwargs.get("page_flip_x", False),
            page_flip_y=kwargs.get("page_flip_y", False),
